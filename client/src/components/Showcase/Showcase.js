    ...
    return (
      ...
      <Container component='main' className={classes.root}>
        ...
        <Grid style = {{display: "flex", flexWrap: "wrap",textAlign: "center", alignItems:"center"}} container spacing={2}>
          ...
          <Grid item xs>
            <img  style = {window.matchMedia("(max-width: 700px)").matches? {width: "240px", height: "240px", margin: "0 auto"}: {width: "400px", height: "400px", margin: "20px auto"} } src={home2} height='400' alt ='girl'/>
          </Grid>
