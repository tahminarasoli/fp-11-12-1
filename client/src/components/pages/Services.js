  ...
  return (
    <div>
      <div className="Services">
        <p>
          You might think that going to do your groceries or shopping is <br />
          ...
          <br /> with this task. Moreover, the COVID-19 pandemic deepens this
          <br /> issue because of the many restrictions that are imposed on us.
          <br />
          ...
          <br /> or a link to connect vulnerable people who need to do their
          <br />
